...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println();
		System.out.println("1: Width: "+myRect1.getWidth()+", Height: "+myRect1.getHeight());
		myRect1.scale(0.5); // applies 0.5 scale to both x and y, changing width to 8, height to 4
		System.out.println("1: Width: "+myRect1.getWidth()+", Height: "+myRect1.getHeight());
		
		System.out.println("2: Width: "+myRect2.getWidth()+", Height: "+myRect2.getHeight());
		myRect2.scale(1,3); // should change height to 24 with width unchanged
		System.out.println("2: Width: "+myRect2.getWidth()+", Height: "+myRect2.getHeight());
		
		System.out.println("3: Width: "+myRect3.getWidth()+", Height: "+myRect3.getHeight());
